    ...
    <main className='min-h-screen bg-gradient-to-b from-gray-900 to-black flex flex-col items-center justify-center px-6'>
      <div className='w-full max-w-sm flex flex-col gap-6'>
        <div className='text-center'>
          ...
          <p className='text-gray-300 mt-1 text-sm'>Inicia sesion</p>
        </div>
        <div className='bg-white rounded-3xl p-6 flex flex-col gap-4'>
          ...
          <div className='flex flex-col gap-1'>
            ...
            <input type='password' value={nip} onChange={e => setNip(e.target.value)} placeholder='4 digitos' maxLength={4} className='border border-gray-200 rounded-xl px-4 py-3 text-sm outline-none focus:border-gray-500' />
          </div>
          <Button onClick={handleLogin} disabled={cargando} className='w-full bg-gray-900 hover:bg-black text-white font-semibold py-6 rounded-2xl'>
