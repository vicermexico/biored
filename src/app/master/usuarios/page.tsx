  ...
  return (
    <main className='min-h-screen bg-gray-50 pb-24'>
      <div className='bg-green-700 px-6 pt-10 pb-6'>
        ...
        <p className='text-green-200 text-sm'>{usuarios.length} registrados</p>
      </div>
          ...
          filtrados.map(u => (
            <div key={u.id} className='bg-white rounded-2xl p-4 shadow-sm flex flex-col gap-3'>
              ...
              <div className='flex gap-2'>
                <button onClick={() => toggleActivo(u.id, u.activo)} className={'flex-1 py-2 rounded-xl text-sm font-medium ' + (u.activo ? 'bg-gray-100 text-gray-600' : 'bg-green-100 text-green-700')}>
